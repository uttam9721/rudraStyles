  ...
  const onSubmitHandler=async(e)=>{
    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='w-full'>
        ...
        value={name}
        className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='Type here.' name="" id="" required/>
      </div>
      <div className='w-full'>
        ...
        value={description}
        className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='Write content here' name="" id="" required/>
      </div>
      ...
      <div>
        ...
        value={price}
        className='w-full px-3 py-2 sm:w-[120px]' type="Number" placeholder='25' name="" id="" />
      </div>
      </div>
      <div>
